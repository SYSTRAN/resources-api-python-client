...
class CorpusSegmentAddTargetRequest(object):
    """
    ...
    def __init__(self):
        ...
        self.systran_types = {
            'corpus_id': 'str',
            'seg_id': 'str',
            'targets': 'list[CorpusAddSegmentTarget]'
        }
        ...
        # Corpus identifier
        self.corpus_id = None  # str
        
        # Segment identifier
        self.seg_id = None  # str
        
        # List of targets
        self.targets = None  # list[CorpusAddSegmentTarget]
